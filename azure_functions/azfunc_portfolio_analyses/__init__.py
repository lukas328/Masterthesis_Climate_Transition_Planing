...
"""
{
    ...
    "input_blob": "portfolio.csv",
    "output_container": "02cleansed",
    "output_blob": "portfolio_analyses.txt",
    "prompt_name": "beiteiligungsportfolio.yaml"
}
"""
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        success = blob_helpers.write_blob_content(
            ...
            content=gpt_response_text, # Write the text response from GPT
            connection_string_env_var=STORAGE_CONN_STR_NAME,
